  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
        <Link href={"/"} className="flex gap-2 flex-center">
            <Image src="/assets/images/logo.svg" alt="Promtoman Logo" width={30} height={30} className="object-contain"/>
            <p className="logo_text">Promtoman</p>
        </Link>
                ...
                <div className="flex">
                    ...
                    {toggleDropDown && (
                        <div className="dropdown">
                            ...
                            <Link href={"/create-promt"} className="dropdown_link" onClick={() => {
                                setToggleDropDown(false)
                            }}>Create Promt</Link>
